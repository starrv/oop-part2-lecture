#5✅. Create a subclass of Pet called Cat
    # import Pet from lib.pet
    # Update the instance in debug.py to rose = Cat('rose', 11, 'domestic longhair', 'sweet', 'rose.jpg', True)

#6✅. Create __init__ that takes all the parameters from Pet and a parameter called indoor 
...
#8✅. Stretch: Create a method called print_pet_details, to match the print_pet_details in Pet    
